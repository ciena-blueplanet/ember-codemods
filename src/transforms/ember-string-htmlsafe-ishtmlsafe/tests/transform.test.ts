...
import transform, {parser} from '#transforms/ember-string-htmlsafe-ishtmlsafe/index.js'
...
runTestCases('ember-string-htmlsafe-ishtmlsafe', __dirname, testCases, transform, parser)
